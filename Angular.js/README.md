This is a guide for writing consistent and aesthetically pleasing angular.js code. It is inspired by what is popular within the community, and flavored with some personal opinions.

This guide was created by [@john_papa](//twitter.com/john_papa) and is licensed under the CC BY-SA 3.0 license. You are encouraged to fork this repository and make adjustments according to your preferences.

Creative Commons License

# Angular 1 Style Guide

>originally based on [johnpapa/angular-styleguide](https://github.com/johnpapa/angular-styleguide)
