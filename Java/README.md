...
1. [Javadoc](#javadoc)
1. [Checkstyle plugin](#checkstyle-plugin)

Note: This guide was extracted from [Google styles guides](http://google.github.io/styleguide/javaguide.html) 
...
Please for detailed instructions about checkstyle, refer to this [link](https://examples.javacodegeeks.com/desktop-java/ide/eclipse/eclipse-checkstyle-plugin-example/)
