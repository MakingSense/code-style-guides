# MakingSense Swift Style Guide

Forked from [raywenderlich Swift styleguide](https://github.com/raywenderlich/swift-style-guide), slightly modified to fit MakingSense conventions.
...
In particular, when adding protocol conformance to a model, avoid adding a separate extension for the protocol methods. With this approach, it's easier to quickly identity the responsibilities of the class.
